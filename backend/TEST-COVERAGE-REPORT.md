...
### 관련 파일
- `C:\test\whs-todolist\backend\test-init.sh` - Bash 테스트 스크립트
- `C:\test\whs-todolist\backend\test-init.ps1` - PowerShell 테스트 스크립트
- `C:\test\whs-todolist\backend\TEST-README.md` - 테스트 사용 가이드
- `C:\test\whs-todolist\backend\TEST-COVERAGE-REPORT.md` - 본 커버리지 보고서
