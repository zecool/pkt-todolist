...
| SQL Injection 방어 | Prepared Statements (Parameterized Query) | P0       |
...
```
Database: PostgreSQL 15+(개발환경에서는 로컬 PostgreSQL을 설치하여 사용)
Hosting: Supabase
...
| 데이터베이스 스키마 작성 및 테이블 생성     | Backend | 1h        |
...
1. 기술 학습 곡선 (React 18, Zustand, PostgreSQL)
2. API 통합 이슈
3. 배포 설정 문제
